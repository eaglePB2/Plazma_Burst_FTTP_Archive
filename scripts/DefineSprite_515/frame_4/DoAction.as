   ...
   while(eval("aso#87533") <= 6)
   {
      if(_root["aso#45610"][gl[eval("aso#87533")]] == 1)
      {
         ...
         if(Math.abs(_root["aso#69566"][gl[eval("aso#87533")]]) < 0.9)
         {
            ...
            {
               _root["aso#45610"][gl[eval("aso#87533")]] = 0;
            }
         }
      }
...
while(a < _root["aso#54383"])
{
   if(_root["aso#45610"][a] == true || _root["aso#45610"][a] == false)
   {
      ...
      if(eval("aso#94914") < 200)
      {
         ...
         _root["aso#69566"][a] -= (this._x - _root["aso#50207"][a]) / eval("aso#94914") * (200 - eval("aso#94914")) * this.p;
         _root["aso#63577"][a] -= (this._y - _root["aso#32240"][a]) / eval("aso#94914") * (200 - eval("aso#94914")) * this.p;
      }
   }
   a++;
}
...
while(eval("aso#87533") < _root.playerstot)
{
   if(_root["aso#56196"]["player" + eval("aso#87533")]["aso#12881"] > 0)
   {
      ...
      if(eval("aso#94914") < 200)
      {
         ...
         _root["aso#56196"]["player" + eval("aso#87533")]["aso#38229"] -= (this._x - _root["aso#56196"]["player" + eval("aso#87533")]._x) / eval("aso#94914") * (300 - eval("aso#94914")) * 0.15 * _root["aso#56196"]["player" + eval("aso#87533")].easymove;
         _root["aso#56196"]["player" + eval("aso#87533")]["aso#75555"] -= (this._y - (_root["aso#56196"]["player" + eval("aso#87533")]._y - 60)) / eval("aso#94914") * (300 - eval("aso#94914")) * 0.15 * _root["aso#56196"]["player" + eval("aso#87533")].easymove;
      }
   }
   eval("aso#87533")++;
}
