   ...
   while(eval("aso#06892") <= 6)
   {
      if(_root["aso#70958"][gl[eval("aso#06892")]] == 1)
      {
         ...
         if(Math.abs(_root["aso#57588"][gl[eval("aso#06892")]]) < 0.9)
         {
            ...
            {
               _root["aso#70958"][gl[eval("aso#06892")]] = 0;
            }
         }
      }
...
while(a < _root["aso#30427"])
{
   if(_root["aso#70958"][a] == true || _root["aso#70958"][a] == false)
   {
      ...
      if(eval("aso#45610") < 200)
      {
         ...
         _root["aso#57588"][a] -= (this._x - _root["aso#00903"][a]) / eval("aso#45610") * (200 - eval("aso#45610")) * this.p;
         _root["aso#51599"][a] -= (this._y - _root["aso#82936"][a]) / eval("aso#45610") * (200 - eval("aso#45610")) * this.p;
      }
   }
   a++;
}
...
while(eval("aso#06892") < _root.playerstot)
{
   if(_root["aso#75555"]["player" + eval("aso#06892")]["aso#69566"] > 0)
   {
      ...
      if(eval("aso#45610") < 200)
      {
         ...
         _root["aso#75555"]["player" + eval("aso#06892")]["aso#26251"] -= (this._x - _root["aso#75555"]["player" + eval("aso#06892")]._x) / eval("aso#45610") * (300 - eval("aso#45610")) * 0.15 * _root["aso#75555"]["player" + eval("aso#06892")].easymove;
         _root["aso#75555"]["player" + eval("aso#06892")]["aso#94914"] -= (this._y - (_root["aso#75555"]["player" + eval("aso#06892")]._y - 60)) / eval("aso#45610") * (300 - eval("aso#45610")) * 0.15 * _root["aso#75555"]["player" + eval("aso#06892")].easymove;
      }
   }
   eval("aso#06892")++;
}
