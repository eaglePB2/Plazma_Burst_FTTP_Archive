...
_root["aso#39621"](this.point5,this.point5b,4);
_root["aso#39621"](this.point6,this.point6b,4);
...
this.onEnterFrame = function()
{
   ...
   while(eval("aso#06892") <= 6)
   {
      if(_root["aso#64969"][gl[eval("aso#06892")]] == 1)
      {
         ...
         if(_root["aso#64969"][gl[eval("aso#06892")]] != 2)
         {
            set("aso#72350",0);
            while(eval("aso#72350") < _root.playerstot)
            {
               if(_root["aso#75555"]["player" + eval("aso#72350")]["aso#32240"] > 0)
               {
                  if(_root["aso#75555"]["player" + eval("aso#72350")].hitTest(_root["aso#69566"][gl[eval("aso#06892")]] + _root["aso#75555"]._x,_root["aso#51599"][gl[eval("aso#06892")]] + _root["aso#75555"]._y,true))
                  {
                     if(_root["aso#75555"]["player" + eval("aso#72350")]["aso#76947"] == 0)
                     {
                        _root["aso#96306"](_root["aso#69566"][gl[eval("aso#06892")]],_root["aso#51599"][gl[eval("aso#06892")]],2);
                     }
                     else
                     {
                        _root["aso#96306"](_root["aso#69566"][gl[eval("aso#06892")]],_root["aso#51599"][gl[eval("aso#06892")]],5);
                     }
                     _root["aso#75555"]["player" + eval("aso#72350")]["aso#32240"] -= 10;
                     if(_root["aso#75555"]["player" + eval("aso#72350")]["aso#32240"] > 0)
                     {
                        _root["aso#75555"]["player" + eval("aso#72350")].gotoAndPlay("hurt");
                     }
                     _root["aso#75555"]["player" + eval("aso#72350")]["aso#35024"] = "all";
                     _root["aso#64969"][gl[eval("aso#06892")]] = 2;
                  }
               }
               eval("aso#72350")++;
            }
...
while(a < _root["aso#36416"])
{
   if(_root["aso#64969"][a] == true || _root["aso#64969"][a] == false)
   {
      ...
      if(eval("aso#14273") < 150)
      {
         ...
         _root["aso#88925"][a] -= (this._x - _root["aso#69566"][a]) / eval("aso#14273") * (150 - eval("aso#14273")) * this.p;
         _root["aso#82936"][a] -= (this._y - _root["aso#51599"][a]) / eval("aso#14273") * (150 - eval("aso#14273")) * this.p;
      }
   }
   a++;
}
...
while(eval("aso#06892") < _root.playerstot)
{
   if(_root["aso#75555"]["player" + eval("aso#06892")]["aso#32240"] > 0)
   {
      ...
      if(eval("aso#14273") < 100)
      {
         ...
         _root["aso#75555"]["player" + eval("aso#06892")]["aso#32240"] -= 150;
         if(_root["aso#75555"]["player" + eval("aso#06892")]["aso#32240"] > 0)
         {
            _root["aso#75555"]["player" + eval("aso#06892")].gotoAndPlay("hurt");
         }
         _root["aso#75555"]["player" + eval("aso#06892")]["aso#35024"] = "all";
         _root["aso#75555"]["player" + eval("aso#06892")]["aso#57588"] -= (this._x - _root["aso#75555"]["player" + eval("aso#06892")]._x) / eval("aso#14273") * (150 - eval("aso#14273")) * 0.2;
         _root["aso#75555"]["player" + eval("aso#06892")]["aso#94914"] -= (this._y - (_root["aso#75555"]["player" + eval("aso#06892")]._y - 60)) / eval("aso#14273") * (150 - eval("aso#14273")) * 0.2;
      }
   }
   eval("aso#06892")++;
}
